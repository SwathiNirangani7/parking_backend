...

{
	   ...
	   stage('Build'){
	         	   ...
	         	   stage('Deployment approval') 
        {
	            ...
	            stage('Deploy'){
              sh '/opt/maven/bin/mvn clean deploy -DaltDeploymentRepository=internal.repo::default::http://admin:admin123@54.79.14.95:8081/nexus/content/repositories/snapshots/'
         }
